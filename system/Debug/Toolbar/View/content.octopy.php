	...
	<div class="toolbar">
		<span id="toolbar-position">
            <a href="javascript: void(0)">
                <img src="data:image/png;base64,">
            </a>
        </span>
		...
		<a id="debug-bar-link" href="javascript:void(0)" title="Open/Close">
			<img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMBAMAAACkW0HUAAAAGFBMVEUAAAA0SV40SV40SV40SV40SV40SV40SV4tbTwAAAAAB3RSTlMAUIOFhoiJ960gEQAAAEJJREFUCB0FwbENgEAMBMFFFsRkn1KCM5dAKcSvC7Z9ZjgarpsV+DZjn4Yyrw2jAUobKG1gNFBmbMYuwwrM5nig7h+btg/A2Q4ZhQAAAABJRU5ErkJggg==">
		</a>
    </div>
@foreach($tool->collectors() as $collector)
    @continue($collector->show === false)
